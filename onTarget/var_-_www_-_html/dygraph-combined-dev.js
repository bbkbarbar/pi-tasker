...
DygraphCanvasRenderer.prototype._createIEClipArea = function() {
  ...
  function createClipDiv(area) {
    ...
    elem.style.backgroundColor = '#00bfff';
...
Dygraph.DEFAULT_WIDTH = 640;
Dygraph.DEFAULT_HEIGHT = 420;
...
Dygraph.DEFAULT_ATTRS = {
  ...
  drawXAxis: true,
  drawYAxis: true,
  axisLineColor: "rgb(176, 214, 201)",
  axisLineWidth: 0.5,
  gridLineWidth: 0.3,
  axisLabelColor: "rgb(255, 204, 0)",
  axisLabelWidth: 50,
  drawYGrid: true,
  drawXGrid: true,
  // gridLineColor: "rgb(128,128,128)",
  gridLineColor: "rgb(176,214,201)",

  interactionModel: null,  // will be set to Dygraph.Interaction.defaultModel
  animatedZooms: true,  // (for now)

  // Range selector options
  showRangeSelector: false,
  rangeSelectorHeight: 40,
  rangeSelectorPlotStrokeColor: "#FF9933",
  rangeSelectorPlotFillColor: "#AA7722",
